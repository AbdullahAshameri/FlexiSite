...
<body data-bs-spy="scroll" data-bs-target=".navmenu" data-bs-offset="80" tabindex="0">
    ...
    <![endif]-->
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('home') }}" class="logo d-flex align-items-center">
                <img src="https://nhc-ye.com/wp-content/uploads/2023/04/logo2.png" alt="Logo" class="logo-img">
            </a>
        ...
        <header id="header" class="header d-flex align-items-center fixed-top"
            ...
            <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
                ...
                <!-- Logo -->
                <a href="{{ route('home') }}" class="logo d-flex align-items-center">
                    <img src="{{ asset('assets/images/hero/logo3.png') }}" alt="Logo" class="logo-img">
                </a>
                <!-- Logo -->
                {{-- <a href="{{ route('home') }}" class="logo d-flex align-items-center">
                    <img src="{{ asset('assets/images/hero/logo3.png') }}" alt="Logo" class="logo-img"
                        style="border: 3px solid #12948B; border-radius: 50%; padding: 4px;">
                </a> --}}
                ...
                <nav id="navmenu" class="navmenu mx-auto">
                    <ul class="d-flex justify-content-center align-items-center mb-0">
                        ...
                        <li><a href="{{ route('about.page') }}"
                                class="{{ request()->routeIs('about.page') ? 'active' : '' }}">{{ __('ABOUT US') }}</a>
                        </li>
                        <li><a href="#services"
                                class="{{ request()->routeIs('services.page') ? 'active' : '' }}">{{ __('SERVICES') }}</a>
                        </li>
                        <li><a href="#products"
                                class="{{ request()->routeIs('services.page') ? 'active' : '' }}">{{ __('PRODUCTS') }}</a>
                        </li>
                        {{-- <li class="dropdown">
                            ...
                            <ul>
                                <li><a href="{{ route('products.index') }}"
                                        class="{{ request()->routeIs('products.index') ? 'active' : '' }}">{{ __('Products') }}</a>
                                </li>
                                <li><a href="product-list.html">Shop List</a></li>
                                <li><a href="product-details.html">Shop Single</a></li>
                                <li><a href="cart.html">Cart</a></li>
                        ...
                        <li><a href="{{ route('blogs.all') }}"
                                class="{{ request()->routeIs('blogs.all') ? 'active' : '' }}">{{ __('INFORMATION') }}</a>
                        </li>
                        <li><a href="{{ route('contact.page') }}"
                                class="{{ request()->routeIs('contact.page') ? 'active' : '' }}">{{ __('CONTACT US') }}</a>
                        </li>
            ...
            <div class="header-lang d-none d-xl-flex align-items-center">
                ...
                <!-- Desktop language select (right) -->
                {{-- <div class="header-lang d-none d-xl-flex align-items-center">
                    <div class="language-buttons" style="display: flex; gap: 8px; align-items: center; background: #12948B; border-radius: 50px">
                        @php
                            $currentLocale = LaravelLocalization::getCurrentLocale();
                            $oppositeLocale = $currentLocale === 'ar' ? 'en' : 'ar';
                            $oppositeLabel = $currentLocale === 'ar' ? 'Englesh' : 'العربية';
                            $oppositeUrl = LaravelLocalization::getLocalizedURL($oppositeLocale, null, [], true);
                        @endphp

                        <a href="{{ $oppositeUrl }}" class="lang-btn"
                            aria-label="{{ $oppositeLocale === 'ar' ? 'العربية' : 'English' }}"
                ...
                <div class="header-lang d-none d-xl-flex align-items-center">
                    <div class="language-buttons"
                        ...
                        @php
                            $currentLocale = LaravelLocalization::getCurrentLocale();
                            $oppositeLocale = $currentLocale === 'ar' ? 'en' : 'ar';
                            $oppositeLabel = $currentLocale === 'ar' ? 'English' : 'العربية';
                            $oppositeUrl = LaravelLocalization::getLocalizedURL($oppositeLocale, null, [], true);
                        @endphp

                        <a href="{{ $oppositeUrl }}" class="lang-btn"
                            aria-label="{{ $oppositeLocale === 'ar' ? 'العربية' : 'English' }}">
                            <img src="https://thirdeyesoft.com/lang_switcher.svg" alt="lang-switch" width="20"
                                height="20">
                            {{ $oppositeLabel }}
                        </a>
                    </div>
                    ...
                    <div class="bottom-inner">
                        <div class="row">
                            ...
                            <div class="single-footer f-contact">
                                ...
                                <p class="phone"><i class="lni lni-map-marker"></i> {{ $footer->address_one }}</p>
                                <p class="phone"><i class="lni lni-map-marker"></i> {{ $footer->address_two }}</p>
                                <p class="phone"><i class="lni lni-map-marker"></i> {{ $footer->address_three }}</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                ...
                                <div class="single-footer f-contact">
                                    ...
                                    @if ($footer->address_three)
                                        <p class="phone"><i class="lni lni-map-marker"></i>
                                            {{ $footer->address_three }}
                                        </p>
                                    @endif
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <!-- Single Widget -->
                                <div class="single-footer f-link">
                                    <h3>{{ __('National Hearing Center') }}</h3>
                                    @if (!empty($footer->short_description_one))
                                        <p class="mb-2" style="line-height: 1.6; color: rgb(0, 0, 0);">
                                            {{ $footer->short_description_one }}
                                        </p>
                                    @endif

                                    @if (!empty($footer->short_description_two))
                                        <p style="line-height: 1.6; color: rgb(0, 0, 0);">
                ...
                <div class="container">
                    <div class="inner-content">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="copyright">
                                    <p>{{ __('All rights reserved') }} ©<a href="https://graygrids.com/"
                                            rel="nofollow" target="_blank">2025</a></p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-12">
                                <ul class="socila">
