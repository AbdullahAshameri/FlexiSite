<div class="form-group">
    <x-form.input label="Product Name" class="form-control-lg" role="input" name="name" :value="old('name', $product->name ?? '')" />
</div>
...
<div class="form-group">
    ...
    <x-form.input type="file" name="image" accept="image/*" />
     @if(!empty($product?->image))
            <img src="{{ ('uploads/' . $product->image) }}" alt="" height="60">
        @else
            <img src="https://www.incathlab.com/images/products/default_product.png" alt="" height="60">
        @endif
</div>
